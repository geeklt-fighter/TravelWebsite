      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.assign('/'); // location.reload(true)   // force reload from the server not the browser cache
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Err Logging out! Trying again');
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [121.038269, 24.655387],
    // zoom: 8
...
var stripe = Stripe('pk_test_51HNqymI2TJzWV13FJpcnciTxQZ1eFq2oba2msr4Pru3jTstU5ipsyBVkkT8GZV9pyLX8gsVUxbrxkjONSBPgwUmw00F9ID4iZh');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Welcome to tl travel");
              window.setTimeout(function () {
                location.assign('/');
              }, 15);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"top5tours.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getTop5Cheap = void 0;
...
var getTop5Cheap = /*#__PURE__*/function () {
  ...
  return function getTop5Cheap() {
    return _ref.apply(this, arguments);
  };
}();

exports.getTop5Cheap = getTop5Cheap;
...
var _top5tours = require("./top5tours");
...
var logoutButton = document.querySelector('.nav-logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
var cards = document.querySelector('.cards');
var menubar = document.querySelector('.fas');
var menu = document.querySelector('.nav-menu'); // UI Change
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.singup)(email, name, password, passwordConfirm);
  });
}
